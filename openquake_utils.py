...
# -*- coding: utf-8 -*-
"""
Created on Mon Apr 15 13:58:42 2024

@author: nbijelic

Modules with GMPEs and required utils from openquake engine 3.18. 


"""

# TODO: implement the Abrahamson Gulerce 2020 (AG2020) GMPE

# openquake functions required for AG2020
# from openquake.hazardlib.gsim.base import CoeffsTable
# from openquake.hazardlib.gsim.base import const
...
#%% from_string functions and IMT as a named tuple
...
#%% Class RecordBuilder
# from openquake.hazardlib.imt import RecordBuilder
# url: https://docs.openquake.org/oq-engine/3.18/reference/_modules/openquake/baselib/general.html
...
#%% Class CoeffsTable
# url: https://docs.openquake.org/oq-engine/3.18/reference/_modules/openquake/hazardlib/gsim/coeffs_table.html
...
# Abrahamson Gulerce 2020 Subduction Zone GMPE
# Code from openquake engine 3.18, url: https://docs.openquake.org/oq-engine/3.18/reference/_modules/openquake/hazardlib/gsim/abrahamson_gulerce_2020.html#AbrahamsonGulerce2020SInter
...
# ctx = np.recarray([(2, 8)], dtype=[('ztor', '<f8'), ('bib', '<f8')], names = ('ztor', 'bib') )
# x = np.recarray([(1.0, 2), (3.0, 4)], dtype=[('x', '<f8'), ('y', '<i8')])
